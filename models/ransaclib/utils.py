...
def create_parser(description):
    ...
    parser.add_argument('--sampler', '-sam', type=int, default=2,
    ...
    parser.add_argument('--tr', '-tr', type=int, default=1,
    ...
    parser.add_argument('--num_workers', '-nw', type=int, default=4, help='how many workers for data loader')
