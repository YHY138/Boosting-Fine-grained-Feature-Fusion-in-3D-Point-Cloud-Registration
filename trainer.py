...
class Trainer:
    ...
    def fit(self, model: GenericModel, train_loader, val_loader=None):
        ...
        print('first step {} global_step {} total_iter {}'.format(first_step, global_step, total_iter))
        ...
        if first_step != 0 and global_step != 0:
            total_iter = total_iter - global_step
            epoch = first_step / len(train_loader)
