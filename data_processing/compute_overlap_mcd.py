...
# General
parser.add_argument('--base_dir', type=str, default='/path/to/your/dataset',
...
def process(phase):
    opt.base_dir = '/path/to/your/dataset/XXX_forTrain'
    with open(f'/path/to/your/dataset/XXX_forTrain/XXX_mergeMiniGap_{phase}.pkl', 'rb') as fid:
