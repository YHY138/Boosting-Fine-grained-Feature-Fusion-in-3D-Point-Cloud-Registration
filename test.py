...
parser.add_argument('--weight_th', type=float, default=0.0, help='Weight threshold for filtering matches')
...
def main():
    ...
    if opt.weight_th > 0.1:
        if not hasattr(cfg, 'test_weight_th'):
            cfg.test_weight_th = opt.weight_th
